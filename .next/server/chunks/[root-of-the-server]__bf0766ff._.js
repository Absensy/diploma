...
async function POST(request) {
    try {
        ...
        const { name, short_description, full_description, materials, production_time, price, discount, discounted_price, image, category_id, is_new, is_popular, is_active } = body;
