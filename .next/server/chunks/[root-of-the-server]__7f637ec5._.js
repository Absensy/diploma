module.exports = [
"[project]/.next-internal/server/app/api/content/our-services/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
async function GET() {
    try {
        const services = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].content.findFirst({
            where: {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(services.data);
    } catch (error) {
...
async function PUT(request) {
    try {
        ...
        const content = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].content.upsert({
            where: {
                section: 'our_services'
            },
            update: {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(content.data);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7f637ec5._.js.map